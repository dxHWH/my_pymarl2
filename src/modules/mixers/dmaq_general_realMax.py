...
class DMAMAXQer(nn.Module):
    def __init__(self, args):
        super(DMAMAXQer, self).__init__()
    ...
    def forward(self, agent_qs, states, actions=None, max_q_i=None, is_v=False):
        ...
        adv_tot, v_tot = self.calc(agent_qs, states, actions=actions, max_q_i=max_q_i, is_v=is_v)
        v_tot = v_tot.view(bs, -1, 1)
        adv_tot = adv_tot.view(bs, -1, 1)
